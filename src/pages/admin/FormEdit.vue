...
export default {
  ...
  methods: {
    getData () {
      this.$axios.get(`damri/getbyid/${this.$route.params.id}`)
        .then(res => {
          if (res.data.sukses) {
    ...
    onSubmit () {
      ...
      this.$axios.put(`damri/edit/${this.$route.params.id}`, formData)
        .then(res => {
          if (res.data.sukses) {
