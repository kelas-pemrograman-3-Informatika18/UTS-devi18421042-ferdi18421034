      ...
      <template v-slot:body="props">
        <q-tr :props="props">
          ...
          <q-td key="Aksi" :props="props">
            <div class="row">
              <div class="col">
                  <q-btn label="Edit" :to="{ name: 'editExecutiveClass', params: { id: props.row._id}}" color="orange" icon="create" unelevated></q-btn>
            </div>
            <div class="row">
              <div class="col">
...
export default {
  ...
  methods: {
    getData () {
      this.$axios.get('executive/tampil')
        .then(res => {
          if (res.data.sukses) {
    ...
    confirm (id) {
      this.$q.dialog({
        ...
        this.$axios.delete('executive/delete/' + id)
          .then((res) => {
            if (res.data.sukses) {
              this.$q.notify({
                type: 'positive',
